...
/**
 * Estratégia concreta para calcular Montante a partir de Juros, Taxa e Tempo.
 * 
 * Fórmula: M = J × (1 + 1 / (i × t))
 * 
 * Padrão Strategy - Componente: Estratégia Concreta
 */
export class MontantePorJurosTaxaTempoStrategy implements CalculoStrategy {
    ...
    calcular(inputs: any): number {
        return this.facade.calcularMontante('jurosTaxaTempo', inputs);
    }
